<template>
  ...
  <div class="disruptive">
    ...
    <div class="container mt-4">
      ...
      <Project-Intro
        title="Disruptive"
        subtitle="Design-centered digital exhibition on Sergio Marchionne and his reconstruction story."
        pill1="UX-UI"
        pill2="Exhibition"
        pill3="Event"/>
     ...
     background-image: url(/images/disruptive/disruptive9.jpg)"
        ...
        <b-col cols="12" md="12" class=" py-md-3 py-2 px-3">
          ...
          <div style="padding:56.25% 0 0 0;position:relative;" class="projectbox">
            <iframe src="https://player.vimeo.com/video/578387348?h=d40c4360c5&title=0&byline=0&portrait=0"
