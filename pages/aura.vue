<template>
  ...
  <div class="aura">
    ...
    <div class="container mt-4">
      ...
      <Project-Intro
        title="Aura Energy"
        subtitle="Brand identity for fictional energy company, which produces energy from people's body heat"
        pill1="Branding"
        pill2="Visual"
        pill3="UI"/>
...
"
     ...
     background-image: url(/images/aura/aura0.jpg)"
        ...
        <b-col cols="12" md="6" class=" py-md-3 py-2 px-3 d-none d-md-block">
...
dire che spazio studiato per avere video e robe digitale che erano state progettate prima solo digitali per cobas19"
     ...
     background-image: url(/images/aura/aura19.jpg)"
        ...
        <b-col cols="12" md="6" class=" d-md-block py-md-3 py-md-2 py-3 px-3 d-none">

          <div class="imgbox pb-0 mb-4 pt-2 pt-md-0">
            <img class="img-parallax imgproject auracard" style="
     background-image: url(/images/aura/aura2.svg)"
                 v-prlx.background="{ speed: 0.1 }"></div>
