<template>
  ...
  <div class="carachioggia">
    ...
    <div class="container mt-4">
      ...
      <Project-Intro
        title="Cara Chioggia ti scrivo"
        subtitle="Digital experience of letters and stories to relive fishing places in Chioggia"
        pill1="UX-UI"
        pill2="Visual"
        pill3="Branding"
      />
...
tutto quello che c'è da sapere su come funziona il sito web."
        ...
        <b-col cols="12" md="12" class=" py-md-3 py-2 px-3">
          ...
          <div style="padding:56.25% 0 0 0;position:relative;" class="projectbox">
            <iframe src="https://player.vimeo.com/video/902889846?h=3c0d8ace14&title=0&byline=0&portrait=0"
