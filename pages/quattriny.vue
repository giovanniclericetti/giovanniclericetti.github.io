<template>
  ...
  <div class="quattriny">
    ...
    <div class="container mt-4">
      ...
      <Project-Intro
        title="Quattriny"
        subtitle="Ironic fictional-branding of a cash provider payment company"
        pill1="Branding"
        pill2="Copywriting"
        pill3="Visual"
     ...
     background-image: url(/images/quattriny/quattriny2.jpg)"
        ...
        <b-col cols="12" md="12" class=" py-md-3 py-2 px-3">
          ...
          <div style="padding:56.25% 0 0 0;position:relative;" class="projectbox">
            <iframe src="https://player.vimeo.com/video/844620983?h=5c4fbc5cc3&title=0&byline=0&portrait=0"
...
The ironic tone of voice is evident in the launch campaign. The phrases on the posters use puns to ironise Italian stereotypes about cash, showing its sarcastic 'convenience' talking about green colour, clean recycling and no more pins or taxes. "
     ...
     background-image: url(/images/quattriny/quattriny4.jpg)"
        ...
        <b-col cols="12" md="8" class="d-md-block d-none py-md-3 py-2 px-3">

          <div style="overflow: hidden" class="p-0 m-0 projectbox d-flex justify-content-center align-items-center">
            <video autoplay loop muted style="width: 100%;">
              <source src="/images/quattriny/quattrinymockup.mp4" type="video/mp4">
